	...
	<div class="row fondo">
		...
		<div class="col-md-12">
			...
			<table class="table table-borderedS">
				...
				<?php foreach($_SESSION["cart"] as $s):?>
				...
				<tr>
					...
					<td style="width:100px;">
						<form id="p-<?=$s["product_id"];?>">
							...
							<input type="number" name="q" id="num-<?=$s["product_id"];?>" value="<?php echo $s["q"]; ?>"
								class="form-control">
						</form>
						<script>
					...
					<td>
						<h4>$ <?php echo $p->price*$s["q"]; ?></h4>
					</td>
					<td style="width:30px;"><a
							href="index.php?action=deletefromcart&product_id=<?php echo $p->id; ?>&href=cart"
							class="btn btn-danger btn-xs"><i class="fa fa-remove"></i></a></td>
					<?php $total += $s["q"]*$p->price; endforeach; ?>
				</tr>
			</table>
